...
enum GenerateFlag {
    GEN_FLAG_LOG_LEVEL_DISABLE = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_DISABLE,
    GEN_FLAG_LOG_LEVEL_ERROR = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_ERROR,
    GEN_FLAG_LOG_LEVEL_WARNING = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_WARNING,
    GEN_FLAG_LOG_LEVEL_INFO = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_INFO,
    GEN_FLAG_LOG_LEVEL_DEBUG = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_DEBUG,
    GEN_FLAG_LOG_LEVEL_TRACE = (int)::QryptSecurity::LogLevel::QRYPTSECURITY_LOG_LEVEL_TRACE,
    GEN_FLAG_ROLE,
